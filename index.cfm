...
<cfsetting enablecfoutputonly="true">
	...
	<p>
		The function, getFlickrPhotoSetPhotos(), accepts one required arguments: <tt>photosetID</tt>.<br />
		The function, getFlickrPhotoSet(), accepts one required arguments: <tt>photosetID</tt>.
	</p>
	<ul>
